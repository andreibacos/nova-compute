...
def neutron_plugins():
    ...
    plugins = {
        ...
        'lb': {
            'config': '/etc/neutron/plugins/linuxbridge/'
                      'lb_neutron_plugin.ini',
            'driver': 'neutron.plugins.linuxbridge.lb_neutron_plugin.'
                      'LinuxBridgePluginV2',
            'contexts': [
                context.SharedDBContext(user=config('neutron-database-user'),
                                        database=config('neutron-database'),
    ...
    if release >= 'icehouse':
        ...
        plugins['ovs']['server_packages'] = ['neutron-server',
                                             'neutron-plugin-ml2']
        plugins['lb']['config'] = '/etc/neutron/plugins/ml2/ml2_conf.ini'
        plugins['lb']['driver'] = 'neutron.plugins.ml2.plugin.Ml2Plugin'
        plugins['lb']['server_packages'] = ['neutron-server',
                                             'neutron-plugin-ml2']
